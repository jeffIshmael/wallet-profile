/** Shared chain, token, and x402 constants for Wallet Analyst / OnFRA. */
...
export const AGENT = {
  name: "OnFRA — Wallet Analyst Financial Intelligence Agent",
  shortName: "OnFRA",
  platform: "Wallet Analyst",
  provider: "Wallet Analyst",
