...
export const metadata: Metadata = {
  title: "Terms of Service | Chainalyse",
  description: "Terms of Service for the Chainalyse Mini App and web platform."
};
...
export default function TermsPage() {
  ...
  return (
    <LegalPageShell title="Terms of Service">
      ...
      <p>
        Chainalyse provides onchain wallet analysis, financial reputation scores, transaction statements, AI-assisted
      ...
      <p>
        ...
        transactions you initiate. Chainalyse does not custody user funds.
      </p>
      ...
      <p>
        You may not misuse Chainalyse, attempt unauthorized access, scrape at abusive rates, or use the service for
      ...
      <p>
        Chainalyse is provided &quot;as is&quot; without warranties. We do not guarantee score accuracy, loan approval,
