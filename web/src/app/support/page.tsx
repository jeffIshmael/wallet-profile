...
export const metadata: Metadata = {
  title: "Support | Onfra",
  description: "Get help with the Onfra Mini App and wallet analysis features."
};
    ...
    <div className="min-h-screen bg-void font-inter text-white">
      ...
      <main className="mx-auto max-w-3xl px-6 py-10">
        ...
        <p className="mt-4 text-sm leading-7 text-stardust">
          Onfra is an independent Mini App — not operated by MiniPay. We aim to respond to critical issues within
        ...
        <div className="mt-8 space-y-6">
          ...
          <section className="rounded-2xl border border-white/10 bg-black/40 p-6">
            ...
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm text-stardust">
              <li>Wallet not connecting — open Onfra inside the MiniPay app (auto-connect).</li>
