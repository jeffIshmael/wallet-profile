...
Prepared for [Onfra](https://app.onfra.xyz). Use this document when filling the [MiniPay Mini App submission form](https://minipay.to/mini-apps) and [Proof of Ship S2](https://www.celopg.eco/programs/proof-of-ship-s2).
...
| **Publisher** | Onfra |
| **Category** | finance |
| **App URL** | https://app.onfra.xyz |
| **Support URL** | https://app.onfra.xyz/support |
| **Terms of Service** | https://app.onfra.xyz/terms |
| **Privacy Policy** | https://app.onfra.xyz/privacy |
| **Icon (512×512)** | https://app.onfra.xyz/icon-512.png |
...
**https://app.onfra.xyz/.well-known/minipay-network-manifest.json**

## PageSpeed Insights

**Mobile report (Jun 22, 2026):** [PageSpeed Insights — app.onfra.xyz](https://pagespeed.web.dev/analysis/https-wallet-profile-orpin-vercel-app/c78c5dhmn1?form_factor=mobile)
...
> **Note:** Canonical production URL is `https://app.onfra.xyz` (app, manifests, and ERC-8004 agent metadata).
...
| Talent App domain verification | ⚠️ Verify on `app.onfra.xyz` |
...
1. Open `https://app.onfra.xyz` inside MiniPay → wallet auto-connects
