...
**Onchain Financial Reputation Agent** — the LangChain/TypeScript backend that powers Onfra. It ingests Celo wallet activity, computes financial scores, generates AI summaries, and compiles verified report attestations.
